...
const theme = ref<ToastPassThroughOptions>({
    ...
    message: `mb-4 not-p-custom:border not-p-custom:backdrop-blur-sm dark:not-p-custom:backdrop-blur-md not-p-custom:rounded-md
        p-info:bg-Purple-50/95 p-info:border-Purple-200 p-info:text-Purple-600 dark:p-info:bg-Purple-500/15 dark:p-info:border-Purple-700/35 dark:p-info:text-Purple-500
    ...
    closeButton: `flex items-center justify-center overflow-hidden relative cursor-pointer bg-transparent select-none
        ...
        p-info:hover:bg-Purple-100 p-info:focus-visible:outline-Purple-600 dark:p-info:hover:bg-white/5 dark:p-info:focus-visible:outline-Purple-500
