...
const dashboardHelpSections = [
    {
        title: 'قراءة الإحصائيات الشاملة',
        icon: TrendingUp,
        color: '#dbeafe',
        iconColor: '#2563eb',
        steps: [
            { title: 'بطاقات المؤشرات الرئيسية', desc: 'استعرض أداء النشاط المالي من خلال بطاقات المبيعات، المرتجعات، المشتريات، وصافي الأرباح في مكان واحد.' },
            { title: 'مؤشرات النمو والتراجع', desc: 'يوضح كل كارت نسبة مئوية سريعة وسهماً (أخضر للنمو، أحمر للتراجع) مقارنة بالفترة المماثلة السابقة.' },
            { title: 'الوصول السريع للتحليلات', desc: 'يمكنك النقر على الأزرار المتاحة في البطاقات للانتقال المباشر إلى الشاشات والتفاصيل المرتبطة بها.' },
        ]
    },
    {
        title: 'تخصيص الفترة الزمنية',
        icon: CalendarRange,
        color: '#fef3c7',
        iconColor: '#d97706',
        steps: [
            { title: 'تحديد النطاق الزمني', desc: 'انقر على زر الفترة الزمنية لاختيار خيارات جاهزة (اليوم، هذا الأسبوع، هذا الشهر) أو تحديد تاريخ بداية ونهاية مخصصين.' },
            { title: 'تحديث الرسوم البيانية', desc: 'بمجرد اختيار الفترة، سيتم إعادة احتساب كافة المؤشرات والرسوم البيانية التفاعلية فوراً.' },
            { title: 'إعادة الضبط', desc: 'اضغط على زر المسح (X) لإعادة عرض البيانات الافتراضية للفترة الحالية.' },
        ]
    },
    {
        title: 'أحدث العمليات والأكثر مبيعاً',
        icon: ShoppingBag,
        color: '#d1fae5',
        iconColor: '#059669',
        steps: [
            { title: 'متابعة العمليات الحديثة', desc: 'يعرض جدول "أحدث الطلبيات" آخر الفواتير الصادرة مع تواريخها، مبالغها، وحالتها الحالية.' },
            { title: 'أفضل المنتجات أداءً', desc: 'يساعدك قسم "أكثر المنتجات مبيعاً" في معرفة المنتجات الأكثر طلباً لضمان توفر رصيد كافٍ منها باستمرار.' },
        ]
    },
    {
        title: 'تنبيهات المخزون والصلاحية',
        icon: AlertTriangle,
        color: '#fee2e2',
        iconColor: '#dc2626',
        steps: [
            { title: 'تنبيهات النفاذ', desc: 'متابعة الأصناف القريبة من الحد الأدنى لتزويد المستودع قبل نفاذها تماماً.' },
            { title: 'انتهاء الصلاحية', desc: 'كشف بالمنتجات القريبة من انقضاء الصلاحية لاتخاذ إجراءات التخفيض أو الإتلاف.' },
        ]
    }
];
const dashboardHelpTips = [
    'تحدث بيانات اللوحة الرئيسية آلياً بمجرد إتمام أي فاتورة بيع جديدة أو تعديل على المخزون.',
    'حساب صافي المبيعات يعتمد على: (إجمالي مبيعات الفترة - إجمالي المرتجعات المقبولة).',
    'راقب مؤشرات المنتجات ذات المخزون المنخفض لتفادي نفاد المنتجات الأساسية من رفوف العرض.'
];
...
<template>
    <div class="dashboard-page">
        ...
        <HelpDrawer
            v-model="showHelp"
            page-title="لوحة التحكم والإحصائيات"
            page-subtitle="نظرة شاملة ومؤشرات أداء النشاط المالي والمتجر"
