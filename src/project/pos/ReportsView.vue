...
const helpSections = [
    {
        title: 'استعراض التقارير المالية',
        icon: FileBarChart,
        color: '#dbeafe',
        iconColor: '#2563eb',
        steps: [
            { title: 'تقرير المبيعات والتحصيلات', desc: 'تحليل المبيعات وتفكيك المقبوضات حسب طرق الدفع والأيام.' },
            { title: 'تقرير الأرباح والخسائر', desc: 'احتساب صافي الربح بعد خصم التكلفة، المصروفات، وتوالف المنتجات.' },
            { title: 'تقييم قيمة المخزون', desc: 'معرفة القيمة الإجمالية للمخزون المتوفر بناءً على أسعار الشراء والبيع.' },
        ]
    }
];
const helpTips = [
    'اعتمد على تقرير الأرباح والخسائر للوقوف على الأداء المالي واستراتيجيات النمو.',
    'تصدير التقارير إلى ملفات Excel أو PDF يتيح أرشفة ومشاركة البيانات بسهولة.'
];
...
<template>
    <div class="reports-page">
        ...
        <HelpDrawer
            v-model="showHelp"
            page-title="التقارير المالية والأداء"
            page-subtitle="تقارير المبيعات، الأرباح والخسائر، وحركة المخزون"
