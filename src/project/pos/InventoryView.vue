...
const inventoryHelpSections = [
    {
        title: 'متابعة حالة المخزون',
        icon: Warehouse,
        color: '#dbeafe',
        iconColor: '#2563eb',
        steps: [
            { title: 'بطاقات ملخص الأرصدة', desc: 'متابعة إجمالي الأصناف، الرصيد السليم، الأصناف النفاذة، والمنتهية بنقرة واحدة.' },
            { title: 'تفاصيل المستودع والرف', desc: 'ملاحظة كمية الصنف الموجودة بالمستودع الرئيسي والكمية المعروضة على رفوف البيع.' },
        ]
    },
    {
        title: 'حركة النقل والتعديل الداخلي',
        icon: ArrowRightLeft,
        color: '#fef3c7',
        iconColor: '#d97706',
        steps: [
            { title: 'النقل لرف البيع', desc: 'تحويل كميات من رصيد المستودع لرف البيع ليتمكن الكاشير من بيعها في شاشة POS.' },
            { title: 'إعادة للمستودع', desc: 'إعادة الفائض من رف البيع إلى المستودع الرئيسي للحفاظ على الترتيب.' },
            { title: 'التعديل اليدوي للكميات', desc: 'تعديل الكميات يدوياً مع تسجيل سبب التعديل لأغراض الجرد والرقابة.' },
        ]
    }
];
const inventoryHelpTips = [
    'تذكر أن نقطة البيع تبيع فقط من كمية رف البيع المتاحة.',
    'انقر على البطاقات الإحصائية العلوية لتصفية الجدول فوراً حسب حالة الصنف.',
    'راجع حركة النقل الداخلي دورياً لمنع التفاوت بين المستودع والرف.'
];
...
<template>
    <div class="inventory-page">
        ...
        <HelpDrawer
            v-model="showHelp"
            page-title="إدارة المخزون والتخزين"
            page-subtitle="متابعة حركة المخزون والنقل بين المستودع والرفوف"
            :page-icon="Warehouse"
