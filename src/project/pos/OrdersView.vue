...
const ordersHelpSections = [
    {
        title: 'أرشيف وتتبع الفواتير',
        icon: ClipboardList,
        color: '#dbeafe',
        iconColor: '#2563eb',
        steps: [
            { title: 'البحث عن فاتورة بيع', desc: 'البحث برقم الفاتورة، اسم العميل، الكاشير، أو نطاق تاريخ محدد.' },
            { title: 'التصفية والتصنيف', desc: 'تصفية الفواتير حسب حالة الدفع (نقدي، شبكة، آجل، مرتجع).' },
        ]
    },
    {
        title: 'معاينة وإعادة الطباعة',
        icon: Eye,
        color: '#d1fae5',
        iconColor: '#059669',
        steps: [
            { title: 'تفاصيل المبيعات والضريبة', desc: 'عرض الأصناف المباعة، الكميات، الخصم، والضريبة المحتسبة.' },
            { title: 'إعادة طباعة الفاتورة', desc: 'إعادة طباعة الإيصال الحراري للعميل بضغطة زر واحدة.' },
        ]
    }
];
const ordersHelpTips = [
    'يمكنك طباعة نسخة بديلة من الفاتورة للعميل في أي وقت من أرشيف الطلبيات.',
    'الفواتير المرتجعة تظهر بعلامة توضح قيمة العملية وتاريخ الإرجاع.'
];
...
<template>
    <div class="orders-page">
        ...
        <HelpDrawer
            v-model="showHelp"
            page-title="سجل الطلبيات والفواتير"
            page-subtitle="أرشيف فواتير البيع وإعادة الطباعة"
